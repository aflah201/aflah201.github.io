...
function nama() {
    ...
    laki.forEach(laki => {
        laki.textContent='An. Moh. Aflah Azzaky';
    });
    
    document.getElementById('nama-perempuan').textContent='Noor Lia Luvi Alviani';
    document.getElementById('nama-ortu-pr').textContent='Bapak Sugik & Ibu Noor Lian Dewi';
    document.getElementById('nama-laki').textContent='Moh. Aflah Azzaky';
    document.getElementById('nama-ortu-lk').textContent='Bapak Kasiyanto & Ibu Indah Khusnia';
